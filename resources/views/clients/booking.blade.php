    ...
    <form action="{{ route('create-booking') }}" method="post" class="booking-container">
        ...
        <div class="booking-info">
            ...
            <label class="payment-option">
                ...
                <img src="{{ asset('clients/assets/images/booking/icon-thanh-toan-momo.png') }}" alt="MoMo">
        ...
        <div class="booking-summary">
            <div class="summary-section">
                ...
                <div class="order-coupon">
                    ...
                    <button style="width: 30%; display: none;" class="btn-remove-coupon" type="button">Hủy mã</button>
                </div>
