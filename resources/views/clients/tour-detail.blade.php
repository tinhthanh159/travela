                    ...
                    <div class="accordion-item">
                        <h5 class="accordion-header">
                            <button class="accordion-button collapsed" data-bs-toggle="collapse"
                                data-bs-target="#collapseTwoOne{{$timeline->timeLineId}}">
                              Ngày {{ $day++ }} - {{ $timeline->title }}
                            </button>
                        </h5>
                        <div id="collapseTwoOne{{$timeline->timeLineId}}" class="accordion-collapse collapse"
                    ...
                    <div class="widget widget-booking" data-aos="fade-up" data-aos-duration="1500"
                        ...
                        <form action="#">
                            ...
                            <div class="text-center">
                                <a href="{{ route('contact') }}">Bạn cần giúp không?</a>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="widget widget-contact" data-aos="fade-up" data-aos-duration="1500"
                        ...
                        <ul class="list-style-one">
                            <li><i class="far fa-envelope"></i> <a
                                    href="emilto:tinhdev9@gmail.com">tinhdev9@gmail.com</a></li>
